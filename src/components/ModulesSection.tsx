...
const ModulesSection: React.FC = () => {
  return <section id="modulos" className="py-16 md:py-24 bg-gradient-to-b from-white to-gray-50 overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900 px-0 my-[121px] mx-[69px] py-[126px]">
        </h2>
              ...
              <Tabs defaultValue="all" className="w-full">
                <TabsContent value="all" className="mt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
                    {modules.map((module, index) => <Card key={index} className={`border-0 shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl pointer-events-auto transform translate-y-0 hover:-translate-y-2 ${module.bgPattern} opacity-0 animate-slide-up`} style={{
                    animationDelay: `${index * 150}ms`,
                    animationFillMode: 'forwards'
                  }}>
                        <CardContent className="p-6 px-[30px]">
                          <div className="flex items-center justify-between mb-4">
                            ...
                            {module.aiPowered && <span className="flex items-center text-sm font-medium text-edubridge-purple bg-edubridge-purple/10 px-3 py-1 rounded-full">
                          ...
                          <Link to={module.url} className="block">
                            <Button className={`w-full bg-gradient-to-r ${module.color} text-white hover:opacity-90 shadow-md transition-all duration-300 hover:shadow-lg group`}>
                              {module.actionText}
                ...
                <TabsContent value="ai" className="mt-0">
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4">
                    {modules.filter(module => module.aiPowered).map((module, index) => <Card key={index} className={`border-0 shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl pointer-events-auto transform translate-y-0 hover:-translate-y-2 ${module.bgPattern} opacity-0 animate-slide-up`} style={{
                    animationDelay: `${index * 150}ms`,
                    animationFillMode: 'forwards'
                  }}>
